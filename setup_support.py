...
def _find_lib():
    ...
    try:
        ...
        includes = subprocess.check_output([PKGCONFIG, '--cflags', '--libs', 'libsecp256k1'])  # noqa S603
        ...
        return os.path.exists(
            os.path.join(os.path.join(os.getenv('CONDA_PREFIX'), 'Library', 'include'), 'secp256k1_ecdh.h')
        )
